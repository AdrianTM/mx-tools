...
EXTRA_FILES="$DESKTOP_PATH/antix/RemasterCC.desktop $DESKTOP_PATH/mx/RemasterCC.desktop $DESKTOP_PATH/antix/live-usb.desktop $DESKTOP_PATH/antix/snapshot-mx.desktop"
